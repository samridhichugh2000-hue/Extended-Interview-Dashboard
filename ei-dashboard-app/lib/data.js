...
// assignments, Exams, Negative feedback are Trainer-only) — per HR, PT
// Team's own applicable set is narrower: the 'All'-scoped signals plus just
// Polls participated. Matches the same narrowing already applied to the
